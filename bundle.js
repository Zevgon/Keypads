...
document.addEventListener('DOMContentLoaded', function () {
  (0, _reactDom.render)(_react2.default.createElement(_app2.default, null), document.getElementById('keypads'));
});
...
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } } /* eslint-disable no-extend-native */
...
var columns = [['o', 'a', 'y', 'lightning', 'staff', 'h', 'backwards_c'], ['backwards_e', 'o', 'backwards_c', 'spiral', 'empty_star', 'h', 'question'], ['copyright', 'butt', 'spiral', 'zh', 'half_three', 'y', 'empty_star'], ['russian_b', 'paragraph', 'b', 'staff', 'zh', 'question', 'smiley'], ['trident', 'smiley', 'b', 'c', 'paragraph', 'full_three', 'full_star'], ['russian_b', 'backwards_e', 'railroad', 'ash', 'trident', 'russian_i', 'omega']];
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function getPictures() {
      ...
      var numLeft = 4;
      var res = [];
      column.forEach(function (picture, idx) {
    ...
    key: 'getButtonStyle',
    value: function getButtonStyle(picture) {
      var ret = buttonStyle;
    ...
    value: function start() {
      var _getPictures = this.getPictures(),
          _getPictures2 = _slicedToArray(_getPictures, 2),
          pictures = _getPictures2[0],
          answer = _getPictures2[1];
    ...
    value: function handleGuess(e, picture) {
      ...
      var newClickedPictures = new Set(this.state.clickedPictures);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.state.running && this.state.pictures.map(function (picture) {
          return _react2.default.createElement(
            'button',
            {
        ...
        this.state.won && _react2.default.createElement(
          'div',
          null,
          'Yay you win!!'
        ),
